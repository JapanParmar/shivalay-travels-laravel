...
<nav id="main-nav" style="position:fixed;top:0;left:0;right:0;z-index:1000;background:var(--color-onyx-black-80);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border-bottom:1px solid var(--color-zinc-hairline);transition:background 0.3s ease, transform 0.3s ease">
  <div class="container" style="display:flex;align-items:center;justify-content:space-between;height:56px">
    ...
    <div style="display:flex;align-items:center;gap:10px">
      <a
        href="https://wa.me/{{ $settings['whatsapp'] ?? '919340994628' }}?text={{ urlencode('Hello ' . ($settings['businessName'] ?? 'Shivalay Travels') . '! I need help with a booking.') }}"
    ...
    <div class="hero-grid">
      ...
      <div>
        ...
        <div class="reveal reveal-d3" style="display:flex;gap:10px;flex-wrap:wrap;margin-bottom:36px">
          ...
          <a
            href="https://wa.me/{{ $settings['whatsapp'] ?? '919340994628' }}"
            target="_blank"
      ...
      <div class="hero-right-visual reveal-scale" style="display:flex;flex-direction:column;gap:12px">
        ...
        <div style="background:var(--color-onyx-black);border:1px solid var(--color-zinc-hairline);border-radius:var(--radius-xl);padding:20px">
          ...
          <form style="display:flex;gap:8px" onsubmit="event.preventDefault(); const ph = this.elements.phone.value; window.open('https://wa.me/{{ $settings['whatsapp'] ?? '919340994628' }}?text=' + encodeURIComponent('Hello {{ $settings['businessName'] ?? 'Shivalay Travels' }}, I need instant booking support. Contact: ' + ph), '_blank');">
            <input class="input-terminal" name="phone" type="tel" placeholder="{{ $settings['phone'] ?? '+91 93409 94628' }}" required style="flex:1">
          ...
          <div style="display:flex; flex-direction:column; gap:16px;">
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px;">
              ...
              <div>
                ...
                <input type="tel" id="prop-guest-phone" class="input-terminal" placeholder="{{ $settings['phone'] ?? '+91 93409 94628' }}" required style="width:100%;" />
              </div>
            </div>
...
<!-- ═══════════════ WHATSAPP FAB ═══════════════ -->
<a href="https://wa.me/{{ $settings['whatsapp'] ?? '919340994628' }}?text={{ urlencode('Hello ' . ($settings['businessName'] ?? 'Shivalay Travels') . '! I need help with a booking.') }}" target="_blank" rel="noopener noreferrer" class="whatsapp-fab" aria-label="Chat on WhatsApp">
