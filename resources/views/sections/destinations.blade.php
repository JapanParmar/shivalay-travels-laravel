      ...
      <div class="destinations-detail-grid">
        ...
        <div style="display: flex; flex-direction: column; gap: 16px;">
          <div id="dest-detail-img-wrap" class="img-zoom-wrap skeleton-loading" style="height: 200px; border-radius: var(--radius-xl); overflow: hidden; position: relative;">
            <img id="dest-detail-img" src="" alt="Destination Details" loading="lazy" style="width: 100%; height: 100%; object-fit: cover; transition: opacity 0.3s ease; opacity: 0;" onload="this.style.opacity=1; this.parentElement.classList.remove('skeleton-loading');">
          </div>
